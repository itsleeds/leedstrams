...
This repository is an R package that provides helpers for working with the
National Library of Scotland (NLS) OS town-plan *XYZ tile pyramids*, used for
the Leeds tram mapping case study.
...
For a reproducible end-to-end download/stitch workflow (including chunked
merging), see the standalone script:
...
Keep remote tile downloads limited when rendering documentation, and prefer
running larger downloads via the script above.
